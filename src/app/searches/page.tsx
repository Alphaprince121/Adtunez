...
const Page = () => {
    ...
    return (
        <div className="min-w-[844px] mx-auto p-6 mt-20 border rounded-lg shadow-lg bg-white">
                    ...
                    <div className="relative flex items-center gap-4">
                        ...
                        <div className="relative">
                            <button
                                ...
                                className="px-2 flex items-center justify-between py-1 rounded-md border border-gray-300 text-[#333333] text-opacity-80 focus:outline-none font-medium text-[12px] leading-[20px] cursor-pointer min-w-[80px] gap-6">
                                {selectedOption}
                                <img src="/icons/down-arrow.png" alt="" className="h-1 w-3 object-contain" />
                            </button>
                            {isDropdownOpen && (
            ...
            <div className="my-4 font-medium text-[14px] leading-[21px] text-[#333333]">
                <p>Top searches and words within searches where people saw your ads</p>
                <div className="flex min-w-[270px] gap-2 border rounded-md p-1 mt-3">
                    <div
                ...
                <div className="flex flex-wrap gap-5 ">
                    {data[activeTab].map((item, index) => (
                        <div className="group relative">
                            ...
                            <div className="hidden group-hover:block absolute shadow-lg z-50 bg-white w-[370px] p-4 rounded-md">
