...
const Page = () => {
    ...
    const options = [
        { defaultColor: "#D9D9D9", selectedColor: "#5C3FF3", label: "Me" },
        { defaultColor: "#D9D9D9", selectedColor: "#5C3FF3", label: "Me and my team" },
    ];
                ...
                <div className="bg-white border border-gray-200 rounded-lg shadow-lg w-[420px]">
                    ...
                    <div className="p-4">
                        <div className="border rounded-md flex justify-around p-1 w-full gap-3">
                            {/* Custom View Button */}
                            <button className="border px-5 rounded-md py-2 w-full font-medium text-[12px] leading-[20px] text-[#333333]">
                                Create Custom View
                            </button>

                            {/* Admin Default Button with Hover Message */}
                            <div className="relative group w-full">
                                <button className="px-5 rounded-md py-2 w-full font-medium text-[12px] leading-[20px] text-[#898D9F]">
                                    Admin Default
                                </button>

                                {/* Tooltip for Admin Default Button */}
                                <div className="hidden group-hover:block absolute top-full left-0 bg-white border p-2 rounded-md shadow-md text-xs text-[#333333]">
                                    <h1>The standard view cannot be edited.</h1>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="mt-3">
                            ...
                            <div className="pt-2 flex gap-7 cursor-pointer">
                                {options.map(({ defaultColor, selectedColor, label }, index) => (
                                    <div
                                        key={index}
                                    ...
                                    >
                                        <div
                                            ...
                                            style={{
                                                backgroundColor: selected === label ? selectedColor : defaultColor,
                                            }}
                                        >
                                ...
                                <div className="w-full max-w-md border rounded-md mt-3">
                                    ...
                                    >
                                        ...
                                        {activeDropdown === "displaySettings" ? (
                                            <img src="/icons/down-arrow.png" className="h-2 rotate-180" />
                                        ) : (
                                            <img src="/icons/down-arrow.png" className="h-2 " />
                                        )}
                                    </div>
                        ...
                        <div className="flex w-full mt-4 gap-4">
                            <button onClick={() => setIsModalOpen(false)} className="w-full py-2 px-5 text-gray-600 text-[14px] leading-[20px] font-semibold border border-gray-300 rounded-md bg-white">
                                Cancel
                            </button>
