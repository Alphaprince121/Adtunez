    ...
    return (
        <div className="relative inline-block text-left" ref={dropdownRef}>
            ...
            <button
                ...
                className="flex items-center justify-start px-[15px] py-2 border font-medium text-[12px] leading-[20px] rounded-md text-[#333333]"
                aria-haspopup="true"
            ...
            {/* Dropdown Menu */}
            {isDropdownOpen && (
                <div className="absolute mt-2 w-72 bg-white border rounded-md shadow-lg z-10 p-4" role="menu">
                    <p className="text-[12px] leading-[16px] font-medium mb-2">Date Range</p>
                    <div className="border-b pb-2 mb-2 relative">
                        {Object.keys(submenuItems).map((menu) => (
                            <div className="relative group" key={menu}>
                                <button
                                    className="flex items-center justify-between px-4 py-2 hover:bg-gray-100 cursor-pointer rounded w-full text-left font-[400] text-[12px] leading-[21px]"
                                ...
                                {activeSubmenu === menu && (
                                    <div className="absolute left-full top-0 ml-2 w-48 bg-white border rounded-md shadow-lg" role="menu">
