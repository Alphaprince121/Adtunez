...
const Page = () => {
    ...
    return (
        <div className="p-3 border rounded-md min-w-[366px] w-full h-[337px]  bg-white">
            <div className="border-b-2 px-2 pb-2 mb-3 flex justify-between">
                <h1 className="font-medium text-[16px] leading-[20px] text-[#333333]">
                    PPC Audit Score
                </h1>
                <h1 className="font-semibold text-[12px] leading-[15px] text-[#4623E9] cursor-pointer underline">
                    View All Audits
                </h1>
            </div>
            ...
            <div className="relative flex justify-center items-center mt-[88px]">
                <div className="absolute h-[220px] min-w-[220px] mt-14 rounded-full  flex justify-center">
            ...
            <div className=" mt-16  flex flex-col items-center justify-center gap-4">
                ...
                <div className="flex justify-center items-center gap-1 -mt-2 cursor-pointer">
                    <h1 className="text-[12px] leading-[15px] font-semibold underline text-[#4623E9]">View Report</h1>
