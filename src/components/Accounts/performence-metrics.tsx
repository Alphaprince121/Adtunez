...
const Page = () => {
    ...
    return (
        <div className="min-w-[1136px] w-full  p-3 bg-[#FFFFFF] rounded-md  space-y-2  border border-gray-200">
            {/* Card Header */}
            <div className="border-b-2 pb-2 flex justify-between items-center">
                <div>
                    <h1 className="text-[16px] font-medium leading-[20px] text-[#333333]">Performance Metrics</h1>
                </div>
            ...
            <div className="flex overflow-hidden gap-[20px] " ref={metricsContainerRef}>
