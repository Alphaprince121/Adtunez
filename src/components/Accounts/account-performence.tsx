const page = () => {
    return (
        <div className="min-w-[347px] w-full h-[277px]   p-3 bg-white rounded-md space-y-3 ">
            {/* Card Header */}
            ...
            <div className="flex text-[#4623E9] pt-3 items-center gap-1 ">
                <h1 className="font-semibold text-[12px] leading-[12px] underline">View Report</h1>
