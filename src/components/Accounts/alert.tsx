const Page = () => {
    return (
        <div className="p-3  border bg-white rounded-md min-w-[155px] w-full">
            {/* Header Section */}
            ...
            <div className="flex flex-col justify-center items-center text-center">
                ...
                <div className="flex px-5 py-1 items-center gap-1 bg-[#F5F5F5] rounded-md ">
                    <button className=" font-medium text-[12px] leading-[17px] text-[#4623E9] ">
                        View
                    </button>
